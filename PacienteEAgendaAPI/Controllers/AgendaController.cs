...
using PacienteEAgendaAPI.Dtos;
using PacienteEAgendaAPI.Models;

namespace PacienteEAgendaAPI.Controllers
{
    [Route("agenda")]
    [ApiController]
    public class AgendaController : ControllerBase
    {
            ...
            {
                var agenda = listaAgenda.Where(item => item.Id == id).FirstOrDefault();/*fazendo busca do funcionario*/
                ...
                return Ok(agenda); /*mostra o funcionario que você excluiu*/
            }
